...
function SearchBill() {
  ...
  return (
    <div>
      <Row style={{margin:"50px", padding: "50px", display: 'flex', alignItems: 'center'}}>
        <Col span={12}>
       ...
       <Row>
         <Col span={8}></Col>
         <Col span={8}>
         <Button key="submit" style={{width: '100%', backgroundColor:'#f05623'}} type="primary" onClick={handleOk}>
          Thêm
        </Button>
         </Col>
       </Row>
