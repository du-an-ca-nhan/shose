...
import { CreateAddressAccountClient }
            ...
            const errors = {
                ...
                district:
                    formAdd.district === undefined || !formAdd.district
                        ...
                        : "",
                ward:
                    formAdd.ward === undefined || !formAdd.ward
                        ? "Chọn phường/xã"
                        : "",
    ...
    return (<React.Fragment>
        ...
        >
            ...
            >
                ...
                <Form.Item >
                    <Checkbox
                        value={isChecked === false ? "DANG_SU_DUNG" : "KHONG_SU_DUNG"}
                        checked={isChecked === true}
                        onChange={(e) => { setIsChecked(e.target.checked); formAddChange("status", e.target.value) }}
                    >
                ...
                <div className="box-action-create-address-account">
                    <div className="buuton-cancel-create-address-account" onClick={closeModalCreate}>Huỷ</div>
                    <div className="buuton-create-address-account" onClick={() => handleCreateAddressClient(formAdd)}>Thêm</div>
                </div>
            </Form>
        </Modal>
