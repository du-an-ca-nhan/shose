...
function Password() {
    ...
    const handleChangePassword = (form) => {
        ...
        AccountClientApi.changePassword(form).then((res) => {
            ...
            <div className="box-form-change-password">
                ...
                <div className="form-change-password">
                    ...
                    >
                        ...
                        <input type={showChangePassword === false ? "password" : "text"} className="input-change-password"
                        ...
                        <FontAwesomeIcon className="show-new-password" icon={showChangePassword === false ? faEyeSlash : faEye} onClick={handleShowChange} />
                    ...
                    >
                        ...
                        <input type={showConfirmPassword === false ? "password" : "text"} className="input-confirm-password"
                            style={{
                        ...
                        />
                        <FontAwesomeIcon className="show-confirm-password" icon={showConfirmPassword === false ? faEyeSlash : faEye}
