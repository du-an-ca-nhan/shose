...
public class DBGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user1 = User.builder()
                ...
                .fullName("Nguyễn Văn Vinh").dateOfBirth(new ConvertDateToLong().dateToLong("01/06/2000")).email("vinh@gmail.com")
        ...
        User user2 = User.builder()
                ...
                .fullName("Đinh Khắc Diệm").dateOfBirth(new ConvertDateToLong().dateToLong("01/06/2000")).email("diem@gmail.com")
        ...
        User user3 = User.builder()
                ...
                .fullName("Nguyên Van Thang").dateOfBirth(new ConvertDateToLong().dateToLong("01/06/20000")).email("thangdt@gmail.com")
        ...
        User hao = User.builder()
                ...
                .fullName("Ngô Vũ Ngọc Hào").dateOfBirth(new ConvertDateToLong().dateToLong("01/06/20000")).email("hao@gmail.com")
                .gender(true).phoneNumber("0987654321").status(Status.DANG_SU_DUNG)
                .build();
        User diem = User.builder()
                ...
                .fullName("Đinh Khắc Diệm").dateOfBirth(new ConvertDateToLong().dateToLong("01/06/20000")).email("diem@gmail.com")
                .gender(true).phoneNumber("0987654321").status(Status.DANG_SU_DUNG)
                .build();
        User oanh = User.builder()
                .avata("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSo1OaW3VfQMuHMJiqrUGUxoEUDI4aNVu6mWQ&usqp=CAU")
                .fullName("Nguyễn Thi Phương Oanh").dateOfBirth(new ConvertDateToLong().dateToLong("01/06/20000")).email("oanh@gmail.com")
                .gender(true).phoneNumber("0987654321").status(Status.DANG_SU_DUNG)
                .build();
        User tuThang = User.builder()
                ...
                .fullName("Nguyên Van Thang").dateOfBirth(new ConvertDateToLong().dateToLong("01/06/20000")).email("thang@gmail.com")
                .gender(true).phoneNumber("0987654321").status(Status.DANG_SU_DUNG)
                .build();
        User vinh = User.builder()
                ...
                .fullName("Nguyễn Văn Vinh").dateOfBirth(new ConvertDateToLong().dateToLong("01/06/20000")).email("vinh@gmail.com")
                .gender(true).phoneNumber("0987654321").status(Status.DANG_SU_DUNG)
                .build();
        User T_Nguyen = User.builder()
                .avata("https://res-console.cloudinary.com/dyq10bthd/thumbnails/v1/image/upload/v1698666496/ZGJuampvdnF6OTdhOGhhbTd1ZmY=/grid_landscape")
                .fullName("Vũ Văn Nguyên").dateOfBirth(new ConvertDateToLong().dateToLong("01/06/1998")).email("nguyen@gmail.com")
                .gender(true).phoneNumber("0987654321").status(Status.DANG_SU_DUNG)
                .build();
